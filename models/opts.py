...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='dianli',
                             help='coco | kitti | coco_hp | pascal | dianli')
    ...
    self.parser.add_argument('--demo', default='/home/pcl/pytorch_work/CenterNet-master/dianli_images',
  ...
  def parse(self, args=''):
    ...
    print("debug dir is", opt.debug_dir)
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    print("opt dataset is", opt.task)
    print("opt dataset is", opt.dataset)
    # print("dataset name is ", dataset.class_name)
    print("class is", dataset.num_classes)
    ...
    print('opt.cat_spec_wh  is',opt.cat_spec_wh )
    print('opt.reg_offset  is',opt.reg_offset )
    print('opt.opt.not_reg_offset  is',opt.not_reg_offset )
    return opt
